...
while ($row = mysqli_fetch_assoc($result)) {
    echo '<tr>
            ...
            <td><a href="subject-details.php?subject_id=' . urlencode($row['subject_id']) . '">' . htmlspecialchars($row['name']) . '</a></td>
            <td>
                <a href="subject-details.php?subject_id=' . urlencode($row['subject_id']) . '" class="btn btn-sm btn-info">View Students</a>
            </td>
          </tr>';
}
